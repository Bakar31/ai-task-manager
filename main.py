...
from tools.get_tasks_by_status import get_tasks_by_status, get_all_tasks, get_tasks_by_status_tool, get_all_tasks_tool
            ...
            while current_iteration < max_iterations:
                ...
                try:
                    ...
                    if not assistant_message.tool_calls:
                        logger.info("No tool calls needed, returning assistant response")
                    ...
                    for tool_call in assistant_message.tool_calls:
                        ...
                        # Ensure the tool result is JSON serializable
                        try:
                    ...
                    error_msg = f"Unexpected error in process_message iteration: {str(e)}"
                    logger.error(error_msg, exc_info=True)
                    return "I encountered an unexpected error. Please try again."
            
            # If we've reached max iterations, return the last response
            return assistant_message.content or "I'm having trouble processing your request. Please try again with more specific details."
